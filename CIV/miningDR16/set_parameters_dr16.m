...
spectra_directory   = @(release)...
   sprintf('data/dr16/sas/dr16/sdss/spectro/redux/v5_13_0/spectra/lite');
...
file_loader = @(plate, mjd, fiber_id) ...
  (read_spec(sprintf("data/dr16/sas/dr16/sdss/spectro/redux/v5_13_0/spectra/lite/%i/spec-%i-%i-%04i.fits", ...
    plate,                                       ...
    plate,                                       ...
    mjd,                                         ...
    fiber_id)));
