...
save(sprintf('%s/civ_samples_N_%d_%d_Sigma_%d_%d_num_%d.mat',...
processed_directory(release), uniform_min_log_nciv*100, uniform_max_log_nciv*100,...
 min_sigma, max_sigma, num_C4_samples),  variables_to_save{:}, '-v7.3');
