...
all_plate_dr7    = dr7q{48};
all_mjd_dr7      = dr7q{47};
all_fiber_dr7    = dr7q{49};
all_RA_dr7       = dr7q{2};
all_DEC_dr7      = dr7q{3};
all_zqso_dr7     = dr7q{4};
num_quasars_dr7  = numel(all_zqso_dr7);
all_QSO_ID_dr7=cell(num_quasars_dr7,1);
all_RATING_c13=zeros(num_quasars_dr7,1)-1;


% getting info from Cooksey Catalog
all_z_civ_c13 = zeros(num_quasars_dr7, 17)-1;
all_N_civ_c13 = zeros(num_quasars_dr7, 17)-1;
all_RATING_c13 = zeros(num_quasars_dr7, 17)-1;
for i=1:num_quasars_dr7
    all_QSO_ID_dr7{i}=sprintf('%05i-%04i-%03i', (all_mjd_dr7(i)), ...
    (all_plate_dr7(i)), (all_fiber_dr7(i)));
    ThisSystems = ismember(c4_QSO_ID, all_QSO_ID_dr7{i});
    ...
    for j=1:nSys
        all_z_civ_c13(i,j) = thisZ_c4s(j);
        all_N_civ_c13(i,j) = thisN_c4s(j);
        all_RATING_c13(i,j) = this_RATING(j);
    end
end
