...
MgII_catalog = load('data/MgII_catalogs/Seyfert_MgII_cat/processed/MgII-cat.mat');
...
variables_to_save = {'offset_z_samples', 'offset_sigma_samples', 'log_nMgII_samples', 'nMgII_samples'};
 ...
 save(sprintf('%s/MgII_samples_%s.mat', processed_directory(release), sample_name),  variables_to_save{:}, '-v7.3');
