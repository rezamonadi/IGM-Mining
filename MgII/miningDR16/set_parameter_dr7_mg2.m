...
loading_min_lambda = 3800;          % range of rest wavelengths to load  Å
loading_max_lambda = 9250;                    
...
z_qso_cut      = 0.4;                      % according to Cooksey z>0.4                      
...
vCut                     = 500;                    % maximum cut velocity for MgII system 
RejectionSampling        = 0;
