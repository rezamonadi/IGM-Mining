...
z_qso_cut      = 0.36;                      % according to Cooksey z>1.7                      
...
normalization_max_lambda_3 = 2280;   % Å  1.0 < z < 2.5
...
train_ratio =1;
training_set_name = 'Seyfert-Full';
testing_set_name = 'DR16';
sample_name = sprintf('N-%d-%d-Sigma-%d-%d-Num-%d',...
                      floor(fit_min_log_nMgII*100),...
                      floor(fit_max_log_nMgII*100),...
                      floor(min_sigma/1e5),      ...
                      floor(max_sigma/1e5), ...
                      num_MgII_samples);
max_MgII = 10; 
...
file_loader_eboss = @(plate, mjd, fiber_id) ...
              (read_spec(sprintf("Spectra/sas/dr16/eboss/spectro/redux/v5_13_0/spectra/lite/%i/spec-%i-%i-%04i.fits", ...
            plate,                                       ...
            plate,                                       ...
            mjd,                                         ...
            fiber_id)));
...
file_loader_sdss= @(plate, mjd, fiber_id) ...
              (read_spec(sprintf("Spectra/sas/dr16/sdss/spectro/redux/26/spectra/lite/%04i/spec-%04i-%i-%04i.fits", ...
            plate,                                       ...
            plate,                                       ...
            mjd,                                         ...
            fiber_id)));
   ...
   %            (read_spec(sprintf("Spectra/sas/dr16/sdss/spectro/redux/103/%04i/spec-%04i-%i-%04i.fits", ...
   %          plate,                                       ...
   %          plate,                                       ...
   %          mjd,                                         ...
   %          fiber_id)));
