...
save(sprintf('%s/plain_EW_sampling-1', processed_directory(training_release)), ...
...
proposal_q = load(sprintf('%s/plain_EW_sampling-1', processed_directory(training_release)));
...
'log_nciv_samples', 'nciv_samples', 'EW_r_a_samples', 'EW_r_b_samples'};
...
plot(xi, EW_r_a_samples./EW_r_b_samples)