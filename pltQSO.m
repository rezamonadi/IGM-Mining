function y=pltQSO(this_flux, this_wavelengths, c4_muL2, c4_muL1,...
                  this_sample_log_likelihoods_c4L2,...
                  sample_z_c4, log_nciv_samples, ttl, fid)


    % been applied this_pixel_mask.
    civ_1548_wavelength = 1548.2040;	;
    ...
    % xlabel('(observed wavelengths $\lambda$ (\AA) / 1548 (\AA)) - 1', 'FontSize', 14, 'Interpreter','latex');
    ylabel('Flux ',                            'FontSize', 14, 'Interpreter','latex');
    ...
    s=scatter(sample_z_c4, log_nciv_samples, 10,...
